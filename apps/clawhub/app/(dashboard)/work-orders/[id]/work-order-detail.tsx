...
import { getValidWorkOrderTransitions, type WorkOrderState } from '@clawhub/core'
import {
  ArrowLeft,
  Loader2,
  ClipboardList,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 bg-bg-3/50 rounded-[var(--radius-md)] border border-bd-0/50">
          ...
          <div className={cn(
            ...
            workOrder.owner === 'agent' ? 'text-status-progress' : 'text-fg-0'
          )}>
            {workOrder.owner === 'agent' ? 'Agent' : 'User'}
          </div>
          <div className="text-xs text-fg-2 mt-1">
