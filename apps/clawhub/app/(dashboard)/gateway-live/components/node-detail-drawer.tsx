        ...
        <Section title="Advanced">
          {rawDetails ? (
            <>
              ...
              <div className="bg-bg-3/50 rounded-[var(--radius-md)] border border-bd-0 overflow-hidden">
                <div className="flex items-center justify-between px-2 py-1.5 border-b border-bd-0 bg-bg-3">
