...
// Workspace root: where ClawHub reads/writes agent files.
//
// Resolution order:
// - OPENCLAW_WORKSPACE (preferred)
// - CLAWHUB_WORKSPACE_ROOT (app-specific)
// - WORKSPACE_ROOT (legacy)
// - Auto-detect: ../../../../.. (when clawhub is checked out under ~/clawd/projects/savORG/apps/clawhub)
// - ./workspace (fallback for demo/dev)
function pickWorkspaceRoot(): string {
  const candidates = [
    process.env.OPENCLAW_WORKSPACE,
    process.env.CLAWHUB_WORKSPACE_ROOT,
