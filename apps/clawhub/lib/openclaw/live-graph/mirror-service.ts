...
import { createWsAdapter, type WsAdapter } from '@clawhub/adapters-openclaw'
import type { AdapterConfig, DeviceIdentity } from '@clawhub/adapters-openclaw'
...
export class GatewayMirrorService extends EventEmitter {
  ...
  // ==========================================================================
  // WEBSOCKET CONNECTION (via @clawhub/adapters-openclaw)
  // ==========================================================================
