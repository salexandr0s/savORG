    ...
    <div className="space-y-2">
      ...
      <div
        className={cn(
          ...
          connectionState === 'connected' && 'bg-status-success/5 border-white/[0.08]',
          connectionState === 'connecting' && 'bg-status-warning/5 border-white/[0.08]',
          connectionState === 'disconnected' && 'bg-bg-2 border-white/[0.06]',
          connectionState === 'error' && 'bg-status-danger/5 border-white/[0.08]'
        )}
      >
      ...
      {showQuietMode && summaryStats && (
        <div className="flex items-center gap-4 px-3 py-2 rounded-[var(--radius-md)] bg-bg-2 border border-white/[0.06]">
          <div className="flex items-center gap-1.5">
