...
export function GraphHeader({ store }: GraphHeaderProps) {
  ...
  return (
    <div className="bg-bg-2 border-b border-white/[0.06] px-4 py-2">
      <div className="flex items-center gap-4 flex-wrap">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'bg-bg-3 text-fg-0 border border-white/[0.08]'
        ...
        {uniqueAgentIds.length > 0 && (
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-2 py-1 text-xs font-medium rounded-[var(--radius-sm)] bg-bg-3 text-fg-1 border border-white/[0.06] focus:outline-none focus:border-bd-1"
            >
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="px-2 py-1 text-xs font-mono rounded-[var(--radius-sm)] bg-bg-3 text-fg-1 border border-white/[0.06] focus:outline-none focus:border-bd-1 w-32"
          />
        </div>
